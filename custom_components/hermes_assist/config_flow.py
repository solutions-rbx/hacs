    ...
    return vol.Schema(
        {
            ...
            ): vol.In(["hermes_plugin", "custom_http"]),
            vol.Required(
                CONF_STT_BASE_URL,
                default=options.get(CONF_STT_BASE_URL, DEFAULT_STT_BASE_URL),
            ): str,
            vol.Required(
                CONF_STT_PATH,
            ...
            vol.Optional(
                CONF_STT_API_TOKEN,
                default=options.get(CONF_STT_API_TOKEN, ""),
            ): str,
            vol.Required(
                CONF_STT_MODEL,
            ...
            vol.Required(
                CONF_TTS_BASE_URL,
                default=options.get(CONF_TTS_BASE_URL, DEFAULT_TTS_BASE_URL),
            ): str,
            vol.Required(
                CONF_TTS_PATH,
            ...
            vol.Optional(
                CONF_TTS_API_TOKEN,
                default=options.get(CONF_TTS_API_TOKEN, ""),
            ): str,
            vol.Required(
                CONF_TTS_MODEL,
    ...
    async def async_step_user(self, user_input: dict[str, Any] | None = None) -> config_entries.FlowResult:
        ...
        if user_input is not None:
            ...
            options = {
                ...
                CONF_STT_BASE_URL: DEFAULT_STT_BASE_URL,
                ...
                CONF_TTS_BASE_URL: DEFAULT_TTS_BASE_URL,
